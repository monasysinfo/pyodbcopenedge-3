...
class OpenEdgeExtentField(models.Field):
    ...
    oetypedict = {'char':[str,'varchar',0],
                  ...
                  'blob':[memoryview,'varchar',0],
                  'clob':[str,'varchar',4194304],
                  'int64':[int,'bigint',0],
                  'raw':[memoryview,'varchar',0],
    ...
    # EDRAS -> added var connection
    def db_type(self, connection):
        return self.oetypedict[self.oetype][1]

    # #EDRAS -> included from_db_value when retrieving data from DB
    ...
    def to_python(self, value):
        ...
        #EDRAS it returns before checking types of fields
