'''
20200124
Commit of the adaptations from Edras Pacolas 

'''

## adaptations from Edras Pacolas  : FieldInfo as BaseFieldInfo
...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    def get_table_list(self, cursor):
        ...
        cursor.execute("SELECT TBL, TBLTYPE FROM SYSPROGRESS.SYSTABLES WHERE OWNER = '%s'"%self.uid)
    ...
    def get_indexes(self, cursor, table_name):
        ...
        for index in indexFull:
            if (index[0] in indexes) is False:
    ...
    ## 20191021 Add get_constraints method
